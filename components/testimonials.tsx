          ...
          <div className="flex items-center space-x-5">
            ...
            <figure>
              <blockquote className="text-lg font-bold m-0 pb-1">
                <p>
                  Our sailing trip through the Greek Islands was incredible. The
                  best vacation experience we've ever had.
                </p>
              </blockquote>
              <figcaption className="text-sm font-medium">
                Patrick Metzger, Sailed in Summer 2025{" "}
        ...
        <div className="p-5 rounded-xl bg-sky-50 border border-sky-200 odd:rotate-1 even:-rotate-1 hover:rotate-0 transition duration-150 ease-in-out">
          <div className="flex items-center space-x-5">
            ...
            <figure>
              <blockquote className="text-lg font-bold m-0 pb-1">
                <p>
                  Hiring a Senior Laravel engineer through JobBoard has been
                  incredible. The best job board experience we've ever had.
                </p>
              </blockquote>
              <figcaption className="text-sm font-medium">
                Annie Patrick, CEO{" "}
